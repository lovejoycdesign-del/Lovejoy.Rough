  ...
  experience: [
    {
      ...
      body: [
        {
          text: "While working in the Health IT department I assisted with the development and design of government software. Helped process contracts, assisted with background checks as well as onboarding, pre-onboarding and terminations. Worked with organizations like the ",
        },
        {
        ...
        {
          text: ") retired, I was employed directly by the Director of Human Resources and worked closely with the Director of Marketing. During this process I learned about the inner workings of running a successful tech company, real-world marketing, advertisement skills and corporate etiquette.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      meta: "LovejoyVisuals · Baltimore, MD",
